...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Quality Leads, Inc.';
$config['webmaster_email'] = 'jason@openskymedia.com';
...
$config['recaptcha_public_key'] = '6LebGcUSAAAAALJa4gvgj0kkA14I11JYIXTZLuGH';
$config['recaptcha_private_key'] = '6LebGcUSAAAAABDydMS-kVqAYrFic3H7R-Xmz0Op';
